...
import { MatHeaderCell, MatColumnDef, MatTableModule, MatCellDef, MatCell, MatHeaderCellDef } from "@angular/material/table";
...
export class LeaderboardPage implements OnInit{
  ...
  ngOnInit(): void {
    this.leaderboardService.getLeaderboardFromBackend()
      .pipe(catchError((err) => {
        console.log(err);
        throw err;
      }))
